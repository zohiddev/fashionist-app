...
// EXTERNAL MODULE: external "react-toast"
var external_react_toast_ = __webpack_require__(9180);
...
const Login = () => {
    ...
    if (code === '') {
      ...
      try {
        ...
        if (res.data.isOk) {
          ...
          external_react_toast_.toast.error(`${lang === 'uz' ? 'Kod xato kiritildi' : 'Код был введен неправильно'}`);
          setPhone('');
          setPassword('');
          setIsVerify(false);
        }
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
    children: [/*#__PURE__*/jsx_runtime_.jsx(external_react_toast_.ToastContainer, {
      position: "top",
      delay: "3000"
    }), /*#__PURE__*/jsx_runtime_.jsx(StyledSessionCard, {
      mx: "auto",
      my: "2rem",
      boxShadow: "large",
