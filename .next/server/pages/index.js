...
var components_Container = __webpack_require__(3158);
...
var grid_Grid = __webpack_require__(7407);
...
const Services = () => {
  ...
  return /*#__PURE__*/jsx_runtime_.jsx(components_Container/* default */.Z, {
    mb: "70px",
    children: /*#__PURE__*/jsx_runtime_.jsx(grid_Grid/* default */.Z, {
      container: true,
      spacing: 6,
      children: serviceList.map((item, ind) => /*#__PURE__*/jsx_runtime_.jsx(grid_Grid/* default */.Z, {
        item: true,
        lg: 4,
        md: 4,
        xs: 12,
...
var products_ProductIntro = __webpack_require__(8198);
...
var modal_Modal = __webpack_require__(7723);
...
const _excluded = (/* unused pure expression or super */ null && (["id", "imgUrl", "title", "price", "off", "product", "rating"]));
...
const SmartphonesView_SmartphonesView = _ref => {
  let {
    id,
    imgUrl,
    title,
  ...
  const state = useSelector(state => state); // const { state, dispatch } = useAppContext()
  ...
  return /*#__PURE__*/_jsxs(StyledProductCard1, _objectSpread(_objectSpread({}, props), {}, {
    children: [/*#__PURE__*/_jsxs("div", {
      className: "image-holder",
      style: {
        padding: '15px'
      },
      children: [product?.is_new > 0 && /*#__PURE__*/_jsx(Chip, {
        position: "absolute",
        bg: "primary.main",
        color: "primary.text",
        fontSize: "10px",
      ...
      children: /*#__PURE__*/_jsx(FlexBox, {
        children: /*#__PURE__*/_jsxs(Box, {
          ...
          children: [/*#__PURE__*/_jsx(Link, {
            ...
            alignItems: "center",
            mt: "10px",
            children: [/*#__PURE__*/_jsxs(SemiSpan, {
              pr: "0.5rem",
              fontWeight: "600",
              color: "primary.main",
              children: [Intl.NumberFormat().format(product?.price), " UZS"]
            }), !!off && /*#__PURE__*/_jsx(SemiSpan, {
              color: "text.muted",
              fontWeight: "600",
      ...
      children: /*#__PURE__*/_jsxs(Card, {
        p: "1rem",
        position: "relative",
        children: [/*#__PURE__*/_jsx(ProductIntro, {
...
/* harmony default export */ const product_cards_SmartphonesView = ((/* unused pure expression or super */ null && (SmartphonesView_SmartphonesView)));
...
const CategorySectionHeader_CategorySectionHeader = ({
  title,
  seeMoreLink,
  iconName
}) => {
  const lang = (0,external_react_redux_.useSelector)(state => state.lang.lang);
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(components_FlexBox/* default */.Z, {
    justifyContent: "space-between",
    alignItems: "center",
    mb: "1.5rem",
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)(components_FlexBox/* default */.Z, {
      alignItems: "center",
      children: [iconName && /*#__PURE__*/jsx_runtime_.jsx(icon_Icon/* default */.Z, {
        defaultcolor: "auto",
        mr: "0.5rem",
        children: iconName
...
/* harmony default export */ const components_CategorySectionHeader = (CategorySectionHeader_CategorySectionHeader);
  ...
  return /*#__PURE__*/_jsx(Container, {
    ...
    children: /*#__PURE__*/_jsx(FlexBox, {
      children: /*#__PURE__*/_jsxs(Box, {
        flex: "1 1 0",
        minWidth: "0px",
        children: [/*#__PURE__*/_jsx(CategorySectionHeader, {
          title: lang === "uz" ? "Ayollar kiyimlari" : "Женская одежда",
          seeMoreLink: "/products/smartfonlar"
        }), /*#__PURE__*/_jsx(Grid, {
          container: true,
          spacing: 6,
          children: smartphones?.map((product, ind) => /*#__PURE__*/_jsx(Grid, {
            item: true,
            lg: 3,
            md: 4,
            sm: 6,
            xs: 6,
            children: /*#__PURE__*/_jsx(SmartphonesView, {
              hoverEffect: true,
              product: product
            })
          }, ind))
...
/* harmony default export */ const home_Smartphones = ((/* unused pure expression or super */ null && (Smartphones)));
...
const SomeProducts = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(components_Container/* default */.Z, {
    mb: window < 568 ? "1.75rem" : "3.75rem",
    ...
    }), /*#__PURE__*/jsx_runtime_.jsx(grid_Grid/* default */.Z, {
      container: true,
      spacing: 6,
      children: recommendedProducts !== null && recommendedProducts?.map((item, ind) => /*#__PURE__*/jsx_runtime_.jsx(grid_Grid/* default */.Z, {
        item: true,
        lg: 3,
        md: 4,
        sm: 6,
...
const CategorySectionCreator = ({
  ...
  return /*#__PURE__*/jsx_runtime_.jsx(components_Box/* default */.Z, {
    mb: window < 568 ? "1.75rem" : "3.75rem",
    children: /*#__PURE__*/(0,jsx_runtime_.jsxs)(components_Container/* default */.Z, {
      pb: "1rem",
...
async function getStaticProps() {
  const [categoriesRes, featuredBrandsRes, slidesRes, mostViewedProductsRes, smartphonesRes, newProductsRes] = await Promise.all([fetch("https://ecommerce.main-gate.appx.uz/dev/v1/category/list"), fetch("https://ecommerce.main-gate.appx.uz/dev/v1/brand/list?featured=1"), fetch("https://ecommerce.main-gate.appx.uz/dev/v1/events/list"), fetch("https://ecommerce.main-gate.appx.uz/dev/v1/product/list?sort=views,desc&per_page=9"), fetch("https://ecommerce.main-gate.appx.uz/dev/v1/category/ayollar-kiyimi?per_page=12"), fetch("https://ecommerce.main-gate.appx.uz/dev/v1/product/list?type=new&per_page=12")]);
  const [categories, featuredBrands, slides, mostViewedProducts, // smartphones,
  newProducts] = await Promise.all([categoriesRes.json(), featuredBrandsRes.json(), slidesRes.json(), mostViewedProductsRes.json(), // smartphonesRes.json(),
  newProductsRes.json()]);
  return {
    props: {
