        ...
        >
            <StyledCategoryMenuItem>
                ...
                >
                    ...
                    <div
                        className='title'
                        style={{ padding: "20px", lineHeight: 1.2 }}
                    >
                        {lang === "uz"
                            ? category[`name_${"uz"}`]
                            : category[`name_${"ru"}`]}
...
const Arrow = ({ side = "left" }) => {
    ...
    return (
        <div
            ...
            onClick={() => {
                if (side === "left") !isFirstItemVisible && scrollPrev();
                else !isLastItemVisible && scrollNext();
            }}
        >
...
const CategoryDetails = ({
    ...
    >
        ...
        <div className='category_banner_details' px='1.25rem' py='0.875rem'>
            <H3
                className='title'
                fontSize='18px'
                textAlign='left'
            ...
            >
                {lang === "uz"
                    ? hoveredCategory[`name_${"uz"}`]
                    : hoveredCategory[`name_${"ru"}`]}
            </H3>
