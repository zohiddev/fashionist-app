    ...
    <Fragment>
      <Card1 mb="2rem">
        <Radio
          ...
          label={
            <Typography ml="6px" fontWeight="600" fontSize="18px"  color='#7D879C'>
              {lang === 'uz' ? 'Click orqali to`lov' : 'Оплата Click'}
            </Typography>
          }
        ...
        <Radio
          ...
          label={
            <Typography ml="6px" fontWeight="600" fontSize="18px" color='#7D879C'>
                {lang === 'uz' ? 'Payme orqali to`lov' : 'Оплата Payme'}
            </Typography>
          }
          onChange={handlePaymentMethodChange}
        />
        ...
        <Radio
          ...
          label={
            <Typography ml="6px" fontWeight="600" fontSize="18px" >
              {lang === 'uz' ? 'Naqd to`lov' : 'Оплата наличными'}
            </Typography>
          }
          onChange={handlePaymentMethodChange}
        />
